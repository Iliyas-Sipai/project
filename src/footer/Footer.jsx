  ...
  <a href="#" className="btn btn-outline-dark">
    <i className="fab fa-amazon"></i>
          ...
          <div className="col-md-2 col-sm-6">
            <div className="footer-menu">
              <h5 className="widget-title">GoShope</h5>
      ...
      <div className="container-lg">
        <div className="row">
          <div className="col-md-6 copyright">
            <p>© 2025 GoShope. All rights reserved.</p>
          </div>
          <div className="col-md-6 credit-link text-start text-md-end">
            <p>GoShope <a href="https://templatesjungle.com/">Mr.Iliyas</a> Distributed By <a href="https://www.tops-int.com/">TopsTechology</a> </p>
          </div>
        </div>
      </div>
    </div> 
